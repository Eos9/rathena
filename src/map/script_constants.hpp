...
/// Do not modify code above this, since it will be automatically generated by the API again
	export_constant(EFST_CASH_VIP);	// VIP ICON	ATHENA
	export_constant(EFST_APACHE); 	// APACHE PREMIUM SERVICE ICON	ATHENA
	...
	export_constant(IT_CHARM);		// ATHENA
