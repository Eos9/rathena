...
static inline int itemtype(t_itemid nameid) {
	...
	return ( type == IT_PETEGG ) ? IT_ARMOR : (type == IT_CHARM) ? IT_ETC : type;	//	ATHENA
}
...
void clif_parse_Emotion(int fd, map_session_data *sd)
{
	...
	if (battle_config.basic_skill_check == 0 || pc_checkskill(sd, NV_BASIC) >= 2 || pc_checkskill(sd, SU_BASIC_SKILL) >= 1) {
		...
		if(battle_config.client_reshuffle_dice && emoticon>=ET_DICE1 && emoticon<=ET_DICE6) {// re-roll dice
			//emoticon = rnd()%6+ET_DICE1;	//	ATHENA
		}
...
void clif_parse_refineui_refine( int fd, map_session_data* sd ){
	...
	if (battle_config.Knuckle_1 && item->refine == 0 && id->weapon_level && id->subtype == W_KNUCKLE)
		cost->randomopt_group = battle_config.Knuckle_1;
	if (battle_config.Knuckle_2 && item->refine == 1 && id->weapon_level && id->subtype == W_KNUCKLE)
		cost->randomopt_group = battle_config.Knuckle_2;
	if (battle_config.Knuckle_3 && item->refine == 2 && id->weapon_level && id->subtype == W_KNUCKLE)
		cost->randomopt_group = battle_config.Knuckle_3;
	if (battle_config.Knuckle_4 && item->refine == 3 && id->weapon_level && id->subtype == W_KNUCKLE)
		cost->randomopt_group = battle_config.Knuckle_4;
	if (battle_config.Knuckle_5 && item->refine == 4 && id->weapon_level && id->subtype == W_KNUCKLE)
		cost->randomopt_group = battle_config.Knuckle_5;
	if (battle_config.Knuckle_6 && item->refine == 5 && id->weapon_level && id->subtype == W_KNUCKLE)
		cost->randomopt_group = battle_config.Knuckle_6;
	if (battle_config.Knuckle_7 && item->refine == 6 && id->weapon_level && id->subtype == W_KNUCKLE)
		cost->randomopt_group = battle_config.Knuckle_7;
	if (battle_config.Knuckle_8 && item->refine == 7 && id->weapon_level && id->subtype == W_KNUCKLE)
		cost->randomopt_group = battle_config.Knuckle_8;
	if (battle_config.Knuckle_9 && item->refine == 8 && id->weapon_level && id->subtype == W_KNUCKLE)
		cost->randomopt_group = battle_config.Knuckle_9;
	if (battle_config.Knuckle_10 && item->refine == 9 && id->weapon_level && id->subtype == W_KNUCKLE)
		cost->randomopt_group = battle_config.Knuckle_10;
	
	if (battle_config.Musical_1 && item->refine == 0 && id->weapon_level && id->subtype == W_MUSICAL)
		cost->randomopt_group = battle_config.Musical_1;
	if (battle_config.Musical_2 && item->refine == 1 && id->weapon_level && id->subtype == W_MUSICAL)
		cost->randomopt_group = battle_config.Musical_2;
	if (battle_config.Musical_3 && item->refine == 2 && id->weapon_level && id->subtype == W_MUSICAL)
		cost->randomopt_group = battle_config.Musical_3;
	if (battle_config.Musical_4 && item->refine == 3 && id->weapon_level && id->subtype == W_MUSICAL)
		cost->randomopt_group = battle_config.Musical_4;
	if (battle_config.Musical_5 && item->refine == 4 && id->weapon_level && id->subtype == W_MUSICAL)
		cost->randomopt_group = battle_config.Musical_5;
	if (battle_config.Musical_6 && item->refine == 5 && id->weapon_level && id->subtype == W_MUSICAL)
		cost->randomopt_group = battle_config.Musical_6;
	if (battle_config.Musical_7 && item->refine == 6 && id->weapon_level && id->subtype == W_MUSICAL)
		cost->randomopt_group = battle_config.Musical_7;
	if (battle_config.Musical_8 && item->refine == 7 && id->weapon_level && id->subtype == W_MUSICAL)
		cost->randomopt_group = battle_config.Musical_8;
	if (battle_config.Musical_9 && item->refine == 8 && id->weapon_level && id->subtype == W_MUSICAL)
		cost->randomopt_group = battle_config.Musical_9;
	if (battle_config.Musical_10 && item->refine == 9 && id->weapon_level && id->subtype == W_MUSICAL)
		cost->randomopt_group = battle_config.Musical_10;

	if (battle_config.Whip_1 && item->refine == 0 && id->weapon_level && id->subtype == W_WHIP)
		cost->randomopt_group = battle_config.Whip_1;
	if (battle_config.Whip_2 && item->refine == 1 && id->weapon_level && id->subtype == W_WHIP)
		cost->randomopt_group = battle_config.Whip_2;
	if (battle_config.Whip_3 && item->refine == 2 && id->weapon_level && id->subtype == W_WHIP)
		cost->randomopt_group = battle_config.Whip_3;
	if (battle_config.Whip_4 && item->refine == 3 && id->weapon_level && id->subtype == W_WHIP)
		cost->randomopt_group = battle_config.Whip_4;
	if (battle_config.Whip_5 && item->refine == 4 && id->weapon_level && id->subtype == W_WHIP)
		cost->randomopt_group = battle_config.Whip_5;
	if (battle_config.Whip_6 && item->refine == 5 && id->weapon_level && id->subtype == W_WHIP)
		cost->randomopt_group = battle_config.Whip_6;
	if (battle_config.Whip_7 && item->refine == 6 && id->weapon_level && id->subtype == W_WHIP)
		cost->randomopt_group = battle_config.Whip_7;
	if (battle_config.Whip_8 && item->refine == 7 && id->weapon_level && id->subtype == W_WHIP)
		cost->randomopt_group = battle_config.Whip_8;
	if (battle_config.Whip_9 && item->refine == 8 && id->weapon_level && id->subtype == W_WHIP)
		cost->randomopt_group = battle_config.Whip_9;
	if (battle_config.Whip_10 && item->refine == 9 && id->weapon_level && id->subtype == W_WHIP)
		cost->randomopt_group = battle_config.Whip_10;
